...
<div style={{display:'flex',justifyContent:'center',marginBottom:22}} > 
          <Button onClick={handleClose}  variant="text"  style={{marginRight:10}}  startIcon={<Iconify icon="material-symbols:arrow-back-rounded" />} >  
                 Go Back
                    ...
                    <Button  variant="contained" onClick={()=>onDownload('xlsx',orderDetail?.customer_name)} startIcon={<Iconify icon="basil:invoice-solid" />}>  
                    Export Excel
                    </Button>
        ...
        <TableRow>
            ...
            <TableCell align="left"><h4>Order Transport Detail</h4></TableCell>
        ...
        <TableRow>
            ...
            <TableCell align='left' >{orderDetail?.ordered_products_transport_detail}</TableCell>
      ...
      <Table sx={{ minWidth: 850 }} aria-label="simple table"   >
        <TableHead sx={{fontWeight:'900'}} >
          <TableRow>
            ...
            <TableCell align="center"><h4>Quantity By</h4></TableCell>
            <TableCell align="center"><h4>Delivery Status</h4></TableCell>
            <TableCell align="left"><h4>Price</h4></TableCell>
        ...
        <TableBody>
            {orderDetail?.products?.map((value,index)=>(
                     ...
                     <TableCell align="center">{value?.product_quantity_by}</TableCell>
                     <TableCell align="center">{value?.product_delivery_status ? 'Shipped' : 'not Shipped'}</TableCell>
                     <TableCell align="left">Rs. 0</TableCell>
    ...
    {/* <hr class="row-invoice brc-default-l1 mx-n1 mb-4" /> */}
                    ...
                    {/* <div class="row-invoice mt-3">
                      ...
                      <p className='total-amount-box' ><strong>Sub Total :</strong> Rs.0</p>
                      <p className='total-amount-box' ><strong style={{paddingRight:'13px'}} >Delivery & Shipping : </strong> Rs.{orderDetail?.delivery_charges}</p>
                      <hr />
                       <p className='total-amount-box total-amount-detail' > <strong style={{paddingRight:'13px'}} >Total Amount : </strong><strong>Rs.0</strong></p>
                      </div>
                       </div>
                    </div> */}
...
<Button  variant="contained"  startIcon={<Iconify icon="basil:invoice-solid" />}>  
                Download Invoice
                    </Button>

...
{numSelected > 0 ? (
      ...
      >
        ...
        <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>props.setOpenDeleteConfimModal(true)} >
          ...
          <ListItemText primary="Delete Brand" primaryTypographyProps={{ variant: 'body2' }} />
        </MenuItem>
...
// ##################### SNACK BAR FUNCTIONs ##################
 ...
 {/* #################### SANCKBAR MESSAGE ######################## */}
    ...
    <div className='category-topbar-box ' >
     ...
     Add Category
         ...
         {/*################ ADD CATEGORY SIDEBAR BUTTON ################*/}
           ...
           {/* CONFIRM MODAL */}
           <ConfimModal open={openDeleteConfimModal} title="Delete" onYes={()=>handleDleteCategories(selected)} message="Do you want to delete?" handleClose={handleCloseConfimModal}  />
       {/* CONFIRM MODAL */}
   ...
   <Button className='search-btn' sx={{mx:2,height:54,px:5,}} type="submit" variant="contained" >
        Search
      </Button>
   </form>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <img className='category-table-image' alt="product" src={row?.category_image ? `${row?.category_image?.image_url}` :noImage } />
                          </a>
                      </TableCell>

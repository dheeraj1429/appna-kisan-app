...
function Addcategory({handleonclosecategory}) {
  return (
    <div>
        <h3 className='edit_h3'>Add Category</h3>
        ...
        <HighlightOffIcon style={{color:palette.primary.main}} onClick={handleonclosecategory} className='close_edit_Category' />

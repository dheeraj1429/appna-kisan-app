...
VendorListToolbar.propTypes = {
  numSelected: PropTypes.number,
  filterName: PropTypes.string,
  onFilterName: PropTypes.func,
};

export default function VendorListToolbar({ numSelected, filterName, onFilterName }) {
...
<Button variant="contained" component={Link} to="#" startIcon={<Iconify icon="eva:plus-fill" />}>
      ...
      >
        <MenuItem sx={{ color: 'text.secondary' }}>
          ...
          <ListItemText primary="vendor" primaryTypographyProps={{ variant: 'body2' }} />
        </MenuItem>

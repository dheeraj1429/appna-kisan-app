...
// ##################### SNACK BAR FUNCTIONs ##################
 ...
 {/* #################### SANCKBAR MESSAGE ######################## */}
  ...
  {/* <Button className='hide-mobile' variant="outlined"  startIcon={<Iconify icon="akar-icons:download" />}> 
   ...
   <TextField id="outlined-basic" type="search" value={searchValue} onChange={(e)=>setSearchValue(e.target.value)} fullWidth  label="Search" placeholder='Search Anything...' variant="outlined"  InputProps={{
          startAdornment: (

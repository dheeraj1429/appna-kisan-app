...
{numSelected > 0 ? (
      ...
      >
            <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>{props.handleOpenSelectedExportOrderSidebar(props?.allOrders,props.selected);setIsOpen2(false)}} >
          <ListItemIcon>
            <Iconify icon="basil:invoice-solid" width={24} height={24} />
          </ListItemIcon>
          <ListItemText primary="Export Selected Order"  primaryTypographyProps={{ variant: 'body2' }} />
        </MenuItem>
...
export default function EnhancedTable() {
  ...
  const [drawerOpenExportOrders, setdrawerOpenExportOrders] = React.useState(false);
  const [drawerOpenSelectedExportOrders, setdrawerOpenSelectedExportOrders] = React.useState(false);
...
//############################# CLOSE DELETE CONFIM MODAL FUNCTION #############################
  ...
  const handleOpenSelectedExportOrderSidebar=async (orders,selected_orders)=>{
...
//############################# SELECTED ORDER EXPORT SIDE BAR DRAWER FUNCTION #############################
  ...
  return (
   ...
   <SideDrawer state={drawerOpenSelectedExportOrders} toggleDrawerClose={handleCloseSelectedExportOrderSideBar} toggleDrawerOpen={handleOpenSelectedExportOrderSidebar}
           ComponentData={<OrderExportPreview orderDetail={forExportSelectedOrders} handleClose={handleCloseSelectedExportOrderSideBar}  />}/>
                 {/*################ Selected Orders Export PREVIEW SIDEBAR  ################*/}

                           {/*################ Selected Orders Export PREVIEW SIDEBAR  ################*/}
   <SideDrawer state={drawerOpenExportOrders} toggleDrawerClose={handleCloseExportOrderSideBar} toggleDrawerOpen={handleOpenExportOrderSidebar}
           ComponentData={<OrderExportPreview orderDetail={allOrders} handleClose={handleCloseExportOrderSideBar}  />}
   ...
   <TextField id="outlined-basic" type="search" value={search} onChange={(e)=>setSearch(e.target.value)} fullWidth  label="Search" placeholder='Search Anything...' variant="outlined"  InputProps={{
          startAdornment: (
...
<Paper elevation={3} sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar setOpenDeleteConfimModal={setOpenDeleteConfimModal} allOrders={allOrders} selected={selected} handleOpenSelectedExportOrderSidebar={handleOpenSelectedExportOrderSidebar}  orderCount={ordersCount} numSelected={selected.length} />
        <TableContainer  >
          <Table
            id="order-to-xls"
            sx={{ minWidth: 750 }}
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" style={{textTransform:'capitalize'}}  >
                        <p style={{cursor:'pointer'}} onClick={()=>{setOrderIdForEdit(row._id); setDrawerEditOrders(true) }}  >
                        {row.customer_name}
                          </p> 
                        </TableCell>
                      <TableCell align="center">{row.customer_phone_number}</TableCell>
                      <TableCell
                      align='center'
                        component="th"
                        id={labelId}
                      ...
                      <TableCell align="center">
                        <p className={row.order_status === "delivered" ? "order_delivered" :
                         ...
                         : row.order_status === "partial delivered"? "order_delivered"

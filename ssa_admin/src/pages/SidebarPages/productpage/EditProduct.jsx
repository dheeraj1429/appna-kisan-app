    ...
    {/* <HighlightOffIcon style={{color:palette.primary.main}}  fontSize='large' /> */}
       ...
       {/* CONFIRM MODAL */}
                ...
                <div className='add_product_form'>
                  ...
                  <div className='add_product_label_input' style={{width:'100%'}} >
                    <label htmlFor=""> Quantity  </label>
                    <TextField type='number'  fullWidth className='product_form_input' id="outlined-basic" name='quantity' value={productData?.quantity} onChange={handleChange} placeholder=" Quantity " variant="outlined" />
                    </div>
                    <div className='add_product_label_input' style={{width:'100%'}} >

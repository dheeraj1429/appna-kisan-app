...
import { approveUserInformation, getSingleB2bAccountDetails } from 'src/api/b2bApproval'
            ...
            {userInformation ? <div>
                ...
                <div className={classes['container']}>
                    ...
                    <div className={classes['box']}>
                        ...
                        <p>{dayjs(userInformation?.createdAt).format('MMM DD YYYY hh:mm:ss A')}</p>
                    </div>
                    {userInformation?.aadhaar?.images && userInformation.aadhaar.images.length ? <div>
                    ...
                    {userInformation?.gstNo?.images && userInformation.gstNo.images.length ? <div>
                    ...
                    {userInformation?.pan?.images && userInformation.pan.images.length ? <div>
                    ...
                    <Stack margin={1} width={100}>
                        <FormControlLabel onChange={(event) => approveHandler(event.target.checked)} control={<Switch defaultChecked={userInformation?.is_approved} />} label="Approval" />
                    </Stack>
                </div>
            </div> : null}
        </div>

  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setProductDetail({
          ...res?.data,
          product_quantity_by: route.params?.product_quantity_by
            ? route.params?.product_quantity_by
            : "piece",
        });
        setLoading(false);
        setRefreshing(false);
        ...
        <View style={{ flex: 1 }}>
          ...
          >
              ...
              <View style={{ marginTop: 30 }}>
                ...
                <View style={{ flexDirection: "row", marginTop: "2%" }}>
                  {userType === "basic" ? (
                    <>
                      <Text
                        style={[styles.descriptionInnerText, { fontSize: 17 }]}
                      >
                        Product Price:{" "}
                      </Text>
                ...
                <Text style={styles.productVariation}>
                  Variation : {productDetail?.product_variant}
                </Text>
                <View style={styles.selectBulkAndSingleBox}>
                  <View style={styles.selectBoxBorder}>
                    <TouchableOpacity
                      onPress={() => selectQuantityBy("piece")}
                      style={{ ...styles.selectSingleBox }}
                      activeOpacity={0.5}
                    >
                      <MaterialIcons
                        ...
                        size={22}
                        color={
                          productDetail?.product_quantity_by == "piece"
                            ? config.primaryColor
                            : "#666"
                        }
                      />
                  ...
                  <View style={styles.selectBoxBorder}>
                    <TouchableOpacity
                      onPress={() => selectQuantityBy("cartoon")}
                      style={{ ...styles.selectSingleBox }}
                      activeOpacity={0.5}
                    >
                      <MaterialIcons
                        ...
                        size={22}
                        color={
                          productDetail?.product_quantity_by == "cartoon"
                            ? config.primaryColor
                            : "#666"
                        }
                      />
                ...
                <View style={styles.quantityAndShareContainer}>
                  ...
                  >
                    <TouchableOpacity
                      ...
                      activeOpacity={0.6}
                      style={styles.chatnowAndCallusIconBox}
                    >
                      <Feather
                        name="phone-call"
                        size={28}
                ...
                {productDetail?.cartoon_total_products && (
                  <Text style={styles.productBulkDetail}>
                    {productDetail?.cartoon_total_products} Piece In One Cartoon
                    *
                  </Text>
                )}
                <View
                ...
                >
                  ...
                  <View style={{ marginTop: 6 }}>
                    <View style={{ flexDirection: "row" }}>
                      <Text style={styles.descriptionInnerText}>
                        Product Code :{" "}
                      </Text>
                      <Text
                        style={{
            ...
            <View style={{ marginBottom: "25%", padding: "5%" }}>
              ...
              >
                <Text style={styles.signInText}>Post Review</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </View>

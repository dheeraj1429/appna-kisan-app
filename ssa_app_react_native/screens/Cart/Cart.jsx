          ...
          <View key={value._id} style={ cartProducts?.length != 1  && cartProducts?.length -1 == index  ?
           ...
           <View style={{flexDirection:'row'}} >
            ...
            <Text style={styles.productName} >{value.product_name?.slice(0,24)}{value?.product_name?.length > 24 &&'...'}</Text>
             ...
             <Text style={styles.brandName} >{value.product_category}</Text> 
             <TouchableOpacity onPress={()=>removeProduct(value._id)} activeOpacity={0.7} style={{paddingLeft:16}} >
            ...
            <Text style={{fontSize:12,color:'#cc0000'}} >Remove</Text>
             ...
             <Text style={{fontWeight:'600',fontSize:15,paddingHorizontal:1,width:48,textAlign:'center',paddingVertical:3}}>
